...
pub fn log_event(conn: &Connection, project: String, full_path: String, activity_type: String, app: String, duration: i32) {
    ...
    println!("Event '{}' logged for {} ({} sec)", activity_type, app, duration);
}